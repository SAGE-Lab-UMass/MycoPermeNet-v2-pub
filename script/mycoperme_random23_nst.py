"Fusion and Fusion+NST with random 23 descriptors from the full set of RDKit descriptors."
...
if fusion and use_MINE:
    ...
    save_dir = f'./results/{GNN}_permeability_random23_fusion_nst_checkpoint'
elif fusion:
