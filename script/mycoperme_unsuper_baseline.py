"Transfer the unsupervised pretrained GNN to run baseline MycoPermeNet-v2."
...
if fusion and use_MINE:
    ...
    save_dir = f'./results/{GNN}_permeability_unsuper_baseline_checkpoint'
...
for i, (torch_seed, data_seed) in enumerate(seed_combinations):
    ...
    if GNN == 'chemprop':
        ...
        model.load_state_dict(torch.load('./results/chemprop_permeability_unsupervised_checkpoint/best_model_0.pt'))
