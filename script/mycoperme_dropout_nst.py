"Ablate NST by using dropout rather than noising labels."
...
if fusion and use_MINE:
    ...
    save_dir = f'./results/{GNN}_permeability_dropout_label_nst_checkpoint'
else:
...
for i, (torch_seed, data_seed) in enumerate(seed_combinations):
    ...
    mlp_model = MLPRegressor(input_dim=X_train.shape[1], hidden_layer_sizes=(128, 64, 16), dropout=0.3)
