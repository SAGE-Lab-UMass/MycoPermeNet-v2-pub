...
if fusion and use_MINE:
    ...
    save_dir = f'./results/{GNN}_permeability_random_fusion_nst_checkpoint'
elif fusion:
    ...
    save_dir = f'./results/{GNN}_permeability_random_checkpoint'
os.makedirs(save_dir, exist_ok=True)

train_df = pd.read_csv('./data/train_random_split.csv')
test_df = pd.read_csv('./data/test_random_split.csv')
