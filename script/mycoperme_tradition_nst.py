"Ablate NST by progressively increasing the model depth and width rather than self-distilling."
...
if fusion and use_MINE:
    ...
    save_dir = f'./results/{GNN}_permeability_tradition_nst_checkpoint'
else:
...
for i, (torch_seed, data_seed) in enumerate(seed_combinations):
    ...
    if not NST:
        ...
        hidden_layer_sizes = [(256, 128, 16), (256, 128, 64, 16), (300, 256, 128, 64, 16)]
        ...
        for iter_i in range(1, nst_iterations + 1):
            ...
            mlp_nst = MLPRegressor(input_dim=X_nst.shape[1], hidden_layer_sizes=hidden_layer_sizes[iter_i - 1])
