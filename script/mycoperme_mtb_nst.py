"Fusion and Fusion+NST with M.tb-related 23 descriptors."
...
if fusion and use_MINE:
    ...
    save_dir = f'./results/{GNN}_permeability_mtb_fusion_nst_checkpoint'
elif fusion:
...
labeled_data_descriptors = pd.read_csv('./data/preprocessed_labeled_descriptors_26.csv')
    ...
    if not NST:
        ...
        for iter_i in range(1, nst_iterations + 1):
            ...
            if i == 0:
                ...
                if fusion:
                    unlabeled_dataset = get_dataset_from_mlsmr_mtb(smiles_chunk, descriptor_names=descriptor_names)
                else:
                    unlabeled_dataset = get_dataset_from_mlsmr_mtb(smiles_chunk)
